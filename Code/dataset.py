...
class HMQAFeatureDataset(Dataset):
    ...
    def prepare_entries(self, questions, part_qid2count, part_qid2count2score, qid_prefix=''):
        ...
        for question in questions:
            ...
            abc=self.img_id2hqma_idx
            if image_id not in abc:
                continue
    ...
    def load_dataset(self):
        ...
        if self.name == "train":
            ...
            vgn_questions = sorted(json.load(open("./data/how_many_qa/HowMany-QA/qzcreate.json")), key=lambda x: x['question_id'])
